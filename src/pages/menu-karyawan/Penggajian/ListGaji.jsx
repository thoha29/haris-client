  ...
  if (!id_user && !loading) {
    return (
      <div className="history-page-wrapper">
        <div className="error-box" style={{ textAlign: 'center', marginTop: '50px' }}>
          <h2>Sesi Berakhir</h2>
  ...
  return (
    <div className="history-page-wrapper">
      ...
      <div className="history-header-simple">
        ...
        <p>Halo, <strong>{username}</strong>! Berikut adalah data slip gaji Anda.</p>
      </div>
      ...
      {loading ? (
        <div style={{ textAlign: 'center', padding: '60px 20px' }}>
          ...
          <p className="mt-3" style={{ color: '#666' }}>Sedang memuat data slip gaji...</p>
        </div>
      ) : riwayat.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', padding: '0 0 40px' }}>
            ...
            <div key={item.id || index}>
              ...
              <div style={{
                ...
                <button
                  ...
                  onClick={() => handleDownloadExcel(item.id, item.nama_lengkap || item.nama)}
                >
